...
int import_oxfd_features_text( char*, struct feature** );
int export_oxfd_features_text( char*, struct feature*, int );
int import_oxfd_features_binary( char*, struct feature** );
int export_oxfd_features_binary( char*, struct feature*, int );
int export_oxfd_features_binary_f( FILE*, struct feature*, int );
void draw_oxfd_features( IplImage*, struct feature*, int );
void draw_oxfd_feature( IplImage*, struct feature*, CvScalar );

int import_lowe_features_text( char*, struct feature** );
int export_lowe_features_text( char*, struct feature*, int );
int import_lowe_features_binary( char*, struct feature** );
int export_lowe_features_binary( char*, struct feature*, int );
...
int export_oxfd_features_binary( char* path, struct feature* feat, int n)
{
  assert(0);
}

int import_oxfd_features_text_f( FILE* f, struct feature** feat)
{
  assert(0);
}

int export_lowe_features_text( char* path, struct feature* feat, int n)
{
  assert(0);
}

int import_lowe_features_text( char* path, struct feature** feat)
{
  assert(0);
}

int import_oxfd_features_binary( char* path, struct feature** feat)
{
  assert(0);
}

int export_oxfd_features_binary_f( FILE* f, struct feature* feat, int n)
{
  assert(0);
}
...
*/
int import_features_binary( char* filename, int type, struct feature** feat )
{
  int n;
  ...
  switch( type )
    {
    case FEATURE_OXFD:
      n = import_oxfd_features_binary( filename, feat );
      break;
    case FEATURE_LOWE:
      n = import_lowe_features_binary( filename, feat );
      break;
    default:
...
int import_features_text( char* filename, int type, struct feature** feat )
{
  int n;
  ...
  switch( type )
    {
    case FEATURE_OXFD:
      n = import_oxfd_features_text( filename, feat );
      break;
    case FEATURE_LOWE:
      n = import_lowe_features_text( filename, feat );
      break;
    default:
      fprintf( stderr, "Warning: import_features(): unrecognized feature" \
	       "type, %s, line %d\n", __FILE__, __LINE__ );
...
int import_features_binary_f( FILE *file, int type, struct feature** feat )
{
  int n;
  ...
  switch( type )
    {
    case FEATURE_OXFD:
      n = import_oxfd_features_binary_f( file, feat );
      break;
    case FEATURE_LOWE:
      n = import_lowe_features_binary_f( file, feat );
      break;
    default:
      fprintf( stderr, "Warning: import_features(): unrecognized feature" \
	       "type, %s, line %d\n", __FILE__, __LINE__ );
  ...
  if( n == -1 )
    fprintf( stderr, "Warning: unable to import features,"	\
	     " %s, line %d\n", __FILE__, __LINE__ );
  return n;
}

int import_features_text_f( FILE *file, int type, struct feature** feat )
{
  int n;
  ...
  switch( type )
    {
    case FEATURE_OXFD:
      n = import_oxfd_features_text_f( file, feat );
      break;
    case FEATURE_LOWE:
      n = import_lowe_features_text_f( file, feat );
      break;
    default:
      fprintf( stderr, "Warning: import_features(): unrecognized feature" \
	       "type, %s, line %d\n", __FILE__, __LINE__ );
...
*/
int export_features_binary( char* filename, struct feature* feat, int n )
{
  int r, type;
  ...
  switch( type )
    {
    case FEATURE_OXFD:
      r = export_oxfd_features_binary( filename, feat, n );
      break;
    case FEATURE_LOWE:
      r = export_lowe_features_binary( filename, feat, n );
      break;
    default:
...
int export_features_binary_f(FILE *file, struct feature* feat, int n )
{
  int r, type;
  ...
  switch( type )
    {
    case FEATURE_OXFD:
      r = export_oxfd_features_binary_f( file, feat, n );
      break;
    case FEATURE_LOWE:
      r = export_lowe_features_binary_f( file, feat, n );
      break;
    default:
      fprintf( stderr, "Warning: export_features(): unrecognized feature" \
	       "type, %s, line %d\n", __FILE__, __LINE__ );
  ...
  if( r )
    fprintf( stderr, "Warning: unable to export features,"	\
	     " %s, line %d\n", __FILE__, __LINE__ );
  return r;
}

int export_features_text( char* filename, struct feature* feat, int n )
{
  int r, type;
  ...
  switch( type )
    {
    case FEATURE_OXFD:
      r = export_oxfd_features_text( filename, feat, n );
      break;
    case FEATURE_LOWE:
      r = export_lowe_features_text( filename, feat, n );
      break;
    default:
      fprintf( stderr, "Warning: export_features(): unrecognized feature" \
	       "type, %s, line %d\n", __FILE__, __LINE__ );
...
int export_features_text_f(FILE *file, struct feature* feat, int n )
{
  int r, type;
  ...
  switch( type )
    {
    case FEATURE_OXFD:
      r = export_oxfd_features_text_f( file, feat, n );
      break;
    case FEATURE_LOWE:
      r = export_lowe_features_text_f( file, feat, n );
      break;
    default:
      fprintf( stderr, "Warning: export_features(): unrecognized feature" \
	       "type, %s, line %d\n", __FILE__, __LINE__ );
...
int import_oxfd_features_binary_f( FILE* file, struct feature** features )
{
    assert(0);
}
...
/*
  ...
  @return Returns the number of features imported from filename or -1 on error
*/
int import_oxfd_features_text( char* filename, struct feature** features )
{
  struct feature* f;
  int i, j, n, d;
  double x, y, a, b, c, dv;
...
int export_oxfd_features_text_f( FILE* file, struct feature* feat, int n )
{
    assert(0);
}
...
/*
  ...
  @return Returns 0 on success or 1 on error
*/
int export_oxfd_features_text( char* filename, struct feature* feat, int n )
{
  FILE* file;
  int i, j, d;
...
int import_lowe_features_binary( char* filename, struct feature** features )
{
  struct feature* f;
  int i, j, n, d;
  double x, y, s, o, dv;
  ...
  result = import_lowe_features_binary_f(file, features);
...
/*
  ...
  @return Returns the number of features imported from filename or -1 on error
*/
int import_lowe_features_binary_f( FILE* file, struct feature** features )
{
  struct feature* f;
  int i, j, n, d;
  float x, y, s, o, dv;
  unsigned char descr_buf[FEATURE_MAX_D];
  unsigned feature_data;
  ...
  if (fread(&n, sizeof(int), 1, file) != 1) {
      perror("Error reading number of features");
      return -1;
  }
  if (fread(&d, sizeof(int), 1, file) != 1) {
      perror("Error reading descriptor dimension");
      return -1;
  }
  ...
  for( i = 0; i < n; i++ )
    {
      /* read affine region parameters */
        if (fread(&y, sizeof(float), 1, file) != 1 ||
            fread(&x, sizeof(float), 1, file) != 1 ||
            fread(&s, sizeof(float), 1, file) != 1 ||
            fread(&o, sizeof(float), 1, file) != 1) {
            perror("Error reading affine region parameters");
            return -1;
        }
      ...
      /* read descriptor */
      if (fread(descr_buf, d, 1, file) != 1) {
          perror("Error reading feature descriptor");
          return -1;
      }
      for (j = 0; j < d; j++) {
	  f[i].descr[j] = descr_buf[j];
      }
      
      /* read feature data */
      if (fread(&feature_data, sizeof(int), 1, file) != 1) {
          perror("Error reading feature data");
          return -1;
      }
      f[i].feature_data = (void*) feature_data;
...
int import_lowe_features_text_f( FILE* file, struct feature** features )
{
  struct feature* f;
  int i, j, n, d;
  double x, y, s, o, dv;
  ...
  for( i = 0; i < n; i++ )
      ...
      for( j = 0; j < d; j++ )
	{
      ...
      {
          unsigned feature_data;
          if (!fscanf(file, " %x", &feature_data)) {
              fprintf(stderr, "Warning: error reading feature data" \
		       " #%d, %s, line %d\n", i+1, __FILE__, __LINE__ );
	      free( f );
	      return -1;
          }
...
int export_lowe_features_binary( char* filename, struct feature* feat, int n )
{
  FILE* file;
  int i, j, d;
  int result;
  ...
  result = export_lowe_features_binary_f(file, feat, n);
...
/*
  ...
  @return Returns 0 on success or 1 on error
*/
int export_lowe_features_binary_f( FILE* file, struct feature* feat, int n )
{
  int i, j, d;
  ...
  for( i = 0; i < n; i++ ) {
      ...
      float ori = feat[i].ori;
      unsigned char descr_buf[FEATURE_MAX_D];
      
      fwrite(&y, sizeof(float), 1, file);
      fwrite(&x, sizeof(float), 1, file);
      fwrite(&scl, sizeof(float), 1, file);
      fwrite(&ori, sizeof(float), 1, file);
      
      for( j = 0; j < d; j++ ) {
          descr_buf[j] = (unsigned char) feat[i].descr[j];
      }
      fwrite(descr_buf, d, 1, file);
      fwrite(&feat[i].feature_data, sizeof(int), 1, file);
    }
...
int export_lowe_features_text_f( FILE* file, struct feature* feat, int n )
{
  int i, j, d;
