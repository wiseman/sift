...
*/
extern int import_features_text( char* filename, int type, struct feature** feat );
extern int import_features_text_f( FILE* file, int type, struct feature** feat );
extern int import_features_binary( char* filename, int type, struct feature** feat );
extern int import_features_binary_f( FILE* file, int type, struct feature** feat );
...
*/
extern int export_features_binary( char* filename, struct feature* feat, int n );

extern int export_features_binary_f(FILE* file, struct feature* feat, int n );

extern int export_features_text( char* filename, struct feature* feat, int n );

extern int export_features_text_f(FILE* file, struct feature* feat, int n );
